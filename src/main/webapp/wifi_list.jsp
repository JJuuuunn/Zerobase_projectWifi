...
<script>
	...
	function input_text() {
		document.getElementById("LAT").value=37.258137;
		document.getElementById("LNT").value=127.033444;
	}
...
<body>
	...
	String LNT2 = request.getParameter("LNT");
	wifi_parsing wifiParsing = new wifi_parsing();
	List<wifi_getset> wifi_getsetList = wifiParsing.list(LAT2,LNT2);
	%>
	<h1>와이파이 정보 구하기</h1>
