...
public class wifi_getset {
    ...
    private String distance; //위경도간 거리(Km)
    private String row; //wifi기록에서 행 번호
...
//  public wifi_getset(
//          String X_SWIFI_MGR_NO, String X_SWIFI_WRDOFC, String X_SWIFI_MAIN_NM, String X_SWIFI_ADRES1, String X_SWIFI_ADRES2,
//          String X_SWIFI_INSTL_FLOOR, String X_SWIFI_INSTL_TY, String X_SWIFI_INSTL_MBY, String X_SWIFI_SVC_SE, String X_SWIFI_CMCWR,
//          String X_SWIFI_CNSTC_YEAR, String X_SWIFI_INOUT_DOOR, String X_SWIFI_REMARS3, String LAT, String LNT, Date WORK_DTTM
//  ) {
